...
#'/home/zvonimir/exrec/data/skill_builder_pickle.pkl'
...
class Data_Loader():
    ...
    def pickle_candidates(self):
        assistments_pickled = PATH_TO_EXREC+'exrec/data/skill_builder_pickle.pkl'
    ...
    def load_ids(self):
        pat = PATH_TO_EXREC+'exrec/data/assist2015/assist2015_qname_qid'
    ...
    def obradi_assistments1(self):
        ...
        outputFilePath = PATH_TO_EXREC+'exrec/data/stan_con.csv'
    ...
    def obradi_assistments2(self):
        ...
        outputFilePath = PATH_TO_EXREC+'exrec/data/stand_exind_nocon.csv'
        self.for_students_write(self,outputFilePath,df)


    def preprocess_gforms(self,filename):
        csv_path=PATH_TO_EXREC+'exrec/data/gforms_raw/'+filename
        df=pd.read_csv(filepath_or_buffer=csv_path,delimiter='\t')

        self.for_students_write(PATH_TO_EXREC+'exrec/data/gforms_raw/'+filename+'processed.csv',df)
